			...
			<div class="col-xl-9 col-lg-8">
				...
				<div class="row gutters-40">
					...
					<div class="col-md-6 col-12">
						<div class="blog-box-layout3">
							<div class="item-img">
								<a href="single-blog.html"><img src="<?php echo path() ?>img/blog/blog120.jpg" alt="blog"></a>
							</div>
							<div class="item-content">
								<ul class="entry-meta meta-color-dark">
					...
					<div class="col-md-6 col-12">
						<div class="blog-box-layout3">
							<div class="item-img">
								<a href="single-blog.html"><img src="<?php echo path() ?>img/blog/blog121.jpg" alt="blog"></a>
							</div>
							<div class="item-content">
								<ul class="entry-meta meta-color-dark">
					...
					<div class="col-md-6 col-12">
						<div class="blog-box-layout3">
							<div class="item-img">
								<a href="single-blog.html"><img src="<?php echo path() ?>img/blog/blog122.jpg" alt="blog"></a>
							</div>
							<div class="item-content">
								<ul class="entry-meta meta-color-dark">
									<li><i class="fas fa-tag"></i>Lab</li>
					...
					<div class="col-md-6 col-12">
						<div class="blog-box-layout3">
							<div class="item-img">
								<a href="single-blog.html"><img src="<?php echo path() ?>img/blog/blog123.jpg" alt="blog"></a>
							</div>
							<div class="item-content">
								<ul class="entry-meta meta-color-dark">
									<li><i class="fas fa-tag"></i>Baby Care</li>
					...
					<div class="col-md-6 col-12">
						<div class="blog-box-layout3">
							<div class="item-img">
								<a href="single-blog.html"><img src="<?php echo path() ?>img/blog/blog124.jpg" alt="blog"></a>
							</div>
							<div class="item-content">
								<ul class="entry-meta meta-color-dark">
									<li><i class="fas fa-tag"></i>Medicine</li>
									<li><i class="fas fa-calendar-alt"></i>Jan 19, 2019</li>
									<li><i class="far fa-clock"></i>5 Mins Read</li>
									<li><i class="fas fa-user"></i>BY <a href="#">Mark Willy</a></li>
								</ul>
								<h3 class="item-title"><a href="single-blog.html">Modern medicine technology
									</a></h3>
								<p>Aimply dummy text of the printing and type are setting industry. Lorem Ipsum
									has
									been the industry's stan dard dummy text ever since the</p>
					...
					<div class="col-md-6 col-12">
						<div class="blog-box-layout3">
							<div class="item-img">
								<a href="single-blog.html"><img src="<?php echo path() ?>img/blog/blog125.jpg" alt="blog"></a>
							</div>
							<div class="item-content">
								<ul class="entry-meta meta-color-dark">
									<li><i class="fas fa-tag"></i>Clinic</li>
					...
					<div class="col-md-6 col-12">
						<div class="blog-box-layout3">
							<div class="item-img">
								<a href="single-blog.html"><img src="<?php echo path() ?>img/blog/blog126.jpg" alt="blog"></a>
							</div>
							<div class="item-content">
								<ul class="entry-meta meta-color-dark">
									<li><i class="fas fa-tag"></i>Medicine</li>
